		...
		<div id="homePage">
			...
			<div id="homeThirdPara">
				<HomeThiFlex
					homePic={homePic1}
					title="자녀 상황 파악"
					body="학습성향검사와 대면 상담을 실시합니다. 이를 통해, 자녀의 학습 습관 뿐만 아니라 자녀의 꿈과 같은 디테일한 부분까지도 꼼꼼히 기록합니다."
				/>
				<HomeThiFlex
					homePic={homePic2}
					title="학원 검증"
					body="교육전문가의 강의 수강평가와, 학원추천 알고리즘을 통해 자녀가 어떤 학원을 가장 즐겁게 다닐 수 있을지 판단합니다."
				/>
				<HomeThiFlex
					homePic={homePic3}
					title="레포트 제공"
					body="학원 검증 결과는 한 눈에 보기 쉽게 레포트 형식으로 제시됩니다. 자녀를 성장시킬 학원이 다양한 지표와 함께 제시됩니다"
				/>
				<div id="homeThiButtons">
					<Link to="#HomeSelectField" id="homeThiButton">
						학습성향검사 신청
					</Link>
					<button id="homeThiButton" onClick={onClickAlert}>
						학원 검증
					</button>
					<button id="homeThiButton" onClick={onClickAlert}>
						레포트 제공
