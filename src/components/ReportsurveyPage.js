		...
		return (
			<div className="reportsurveyBody">
				...
				<div className="reportsurveyField">
					<progress className="reportsurveyProg" value={this.state.prog} max="70" id="jb" />
					...
					{three ? (
						<ReportsurveyDefault optionChange={this.onOptionCallback} subjectChange={this.onSubjectCallback} />
					) : (
						''
					)}
					{four ? (
						<ReportsurveyQuestion
							queChange={this.onQueOneCallback}
							option="학원별 점수 추천사유 공개"
							queChangeBack={this.onOptionCallback}
						/>
					) : (
						''
					)}
					{five ? (
						<ReportsurveyQuestion
							queChange={this.onQueTwoCallback}
							option="자문료의 절반 환불"
							queChangeBack={this.onQueOneCallback}
						/>
					) : (
						''
					)}
					{six ? (
						<ReportsurveyQuestion
							queChange={this.onQueThreeCallback}
							option="월 2회 면담"
							queChangeBack={this.onQueTwoCallback}
						/>
					) : (
						''
					)}
	...
	render() {
		return (
			<div className="reportsurveyCompBody">
				...
				<button className="reportsurveyCompButton" id="1" onClick={this.gradeClick}>
					초등학생
				</button>
				<button className="reportsurveyCompButton" id="2" onClick={this.gradeClick}>
					중학교 1~2학년
				</button>
				<button className="reportsurveyCompButton" id="3" onClick={this.gradeClick}>
					중학교 3학년
				</button>
				<button className="reportsurveyCompButton" id="4" onClick={this.gradeClick}>
					고등학교 1학년
				</button>
				<button className="reportsurveyCompButton" id="5" onClick={this.gradeClick}>
					고등학교 2학년
				</button>
				<button className="reportsurveyCompButton" id="6" onClick={this.gradeClick}>
					고등학교 3학년
				</button>
			</div>
		);
			...
			<div className="reportsurveyCompBody">
				...
				<label className="reportsurveyCompButton">
					<input
						...
						name="checkboxGroup"
						value="kor"
						checked={this.state.checkboxGroup['kor']}
				...
				<label className="reportsurveyCompButton">
					<input
						...
						name="checkboxGroup"
						value="mat"
						checked={this.state.checkboxGroup['mat']}
						onChange={this.handleCheckbox}
					/>
					수학
				</label>
				<label className="reportsurveyCompButton">
					<input
						...
						name="checkboxGroup"
						value="eng"
						checked={this.state.checkboxGroup['eng']}
						onChange={this.handleCheckbox}
					/>
					영어
				</label>
				<label className="reportsurveyCompButton">
					<input
						...
						name="checkboxGroup"
						value="sci"
						checked={this.state.checkboxGroup['sci']}
						onChange={this.handleCheckbox}
					/>
					과학
				</label>
				<label className="reportsurveyCompButton">
					<input
						...
						name="checkboxGroup"
						value="soc"
						checked={this.state.checkboxGroup['soc']}
						onChange={this.handleCheckbox}
					/>
					사회
				</label>
				<label className="reportsurveyCompButton">
					<input
						...
						name="checkboxGroup"
						value="all"
						checked={this.state.checkboxGroup['all']}
						onChange={this.handleCheckbox}
					/>
					학습전반
				</label>
				<label className="reportsurveyCompButton">
					<input
						...
						name="checkboxGroup"
						value="oth"
						checked={this.state.checkboxGroup['oth']}
						onChange={this.handleCheckbox}
					/>
					기타
				</label>
				<div className="reportsurveyCompBN">
					<button className="reportsurveyCompBack" onClick={this.gradeClick}>
						뒤로
					</button>
					<button className="reportsurveyCompNext" onClick={this.subjectClick}>
						다음
					</button>
				</div>
			</div>
	...
	render() {
		return (
			<div className="reportsurveyCompBody">
				...
				<div>
					학습 성향 진단 <br /> 추천 학원 제시 <br /> 중장기 학습전략 제시
				</div>
				<div className="reportsurveyCompBN">
					<button className="reportsurveyCompBack" onClick={this.defaultClickBack}>
						뒤로
					</button>
					<button className="reportsurveyCompNext" onClick={this.defaultClickNext}>
						다음
					</button>
				</div>
			</div>
		...
		return (
			<div className="reportsurveyCompBody">
				...
				<div className="reportsurveyCompBN">
					...
					<button className="reportsurveyCompBack" id="2" onClick={this.defaultClickNext}>
						괜찮아요
					</button>
					<button className="reportsurveyCompNext" id="1" onClick={this.defaultClickNext}>
						해주세요
					</button>
				</div>
			</div>
