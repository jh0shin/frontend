...
function HomeLectureInput() {
	...
	const onChangeLcall = (e) => {
		setLcall(e.target.value);
	};
		...
		<Fragment>
			<div className="inputField">
				...
				<textarea
					...
					rows="10"
					cols="30"
					placeholder="기타 요청 사항 (관심 과목, 성적대, 성향 등)"
				/>
				<div className="checkboxFlex">
					<label className="checkbox">
						<input type="checkbox" onChange={() => setIsChecked(!isChecked)} name="agree" />
					</label>
